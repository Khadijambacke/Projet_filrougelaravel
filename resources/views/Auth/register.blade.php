                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user"  action="{{ route('register') }}" method="POST">
                              ...
                              @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user"  name= "name" value="{{ old('name' , '') }} id="exampleLastName"
                                            placeholder="Name">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user"  name= "role"  id="exampleLastName"
                                            placeholder="Role">
                                    </div>
                                </div>
                                ...
                                <!--capturer les erreurs et nous les rnvoyer!-->
                                @if($errors->any())
                                   <ul class="errors">
                            ...
                            <div class="text-center">
                                <a class="small" href="Redirect::to('/dashboard') }}">Already have an account? Login!</a>
                            </div>
                        </div>
                    </div>
                </div>

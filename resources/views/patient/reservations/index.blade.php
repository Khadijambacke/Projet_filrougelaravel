                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card shadow-sm h-100 border-start border-4 border-{{ $statusColors[$res->statut] }}">
                        <div class="card-body d-flex flex-column">
                            ...
                            <p class="card-text mb-1"><strong>Date :</strong>{{ $res->
                                date_reservation}}</p>
                    ...
                    <!-- Systeme de gestion des normlaisations des pages web -->
                    <!-- de ce fait j'ai besion de matcha qui permettrer de faie et cela
                    c'est pour tout une sejmesttre de mon apprentisage  -->
                </div>
            @endforeach
        </div>
    @endif
